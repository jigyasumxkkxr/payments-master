    ...
    return (
        <div className="flex items-center justify-center h-screen w-screen bg-slate-300">
            <div className="h-fit w-1/4 bg-gray-100 rounded-2xl shadow-lg shadow-slate-500 flex-col items-center justify-center">
                ...
                <Button onClick={handleClick} disabled={loading} label={loading ? <svg aria-hidden="true" role="status" class="inline w-4 h-4 me-3 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
